...
public class AccountController {
    ...
    public ResponseEntity<Object> register(@RequestBody NewAccount newAccount) {
    ...
    public ResponseEntity<Object> updateUserById(@PathVariable("id") Long id, @RequestBody UpdateAccount account) {
