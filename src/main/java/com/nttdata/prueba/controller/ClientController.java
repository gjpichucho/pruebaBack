...
public class ClientController {
    ...
    public ResponseEntity<Object> register(@RequestBody NewClient newClient) {
    ...
    public ResponseEntity<Object> updateUserById(@PathVariable("id") Long id, @RequestBody UpdateClient client) {
