...
public class MovementController {
    ...
    public ResponseEntity<Object> register(@RequestBody NewMovement newMovement) {
    ...
    public ResponseEntity<Object> updateUserById(@PathVariable("id") Long id, @RequestBody UpdateMovement account) {
